 ...
 */
    ...
    class registro_inicioPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Registro Inicio');
            $this->SetMenuLabel('Registro Inicio');
        ...
        protected function setupFilterBuilder(FilterBuilder $filterBuilder, FixedKeysArray $columns)
        {
            ...
            $main_editor = new TextEdit('user_token');
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            //
            $editor = new TextAreaEdit('user_token_edit', 50, 8);
    ...
    try
    {
        $Page = new registro_inicioPage("registro_inicio", "registro_inicio.php", GetCurrentUserPermissionsForPage("registro_inicio"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("registro_inicio"));
