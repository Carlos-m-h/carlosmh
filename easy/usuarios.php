    ...
    class usuariosPage extends Page
    {
        protected function DoBeforeCreate()
        {
            ...
            $this->dataset->addFields(
                array(
                    ...
                    new StringField('contraseña', true),
                    new DateTimeField('fecha_registro'),
                    new StringField('rol', true)
                )
            );
        }
        ...
        protected function getFiltersColumns()
        {
            return array(
                ...
                new FilterColumn($this->dataset, 'contraseña', 'contraseña', 'Contraseña'),
                new FilterColumn($this->dataset, 'fecha_registro', 'fecha_registro', 'Fecha Registro'),
                new FilterColumn($this->dataset, 'rol', 'rol', 'Rol')
            );
        }
        ...
        protected function setupQuickFilter(QuickFilter $quickFilter, FixedKeysArray $columns)
        {
            $quickFilter
                ...
                ->addColumn($columns['contraseña'])
                ->addColumn($columns['fecha_registro'])
                ->addColumn($columns['rol']);
        }
        ...
        protected function setupFilterBuilder(FilterBuilder $filterBuilder, FixedKeysArray $columns)
        {
            ...
            $main_editor = new TextEdit('contraseña_edit');
            ...
            $main_editor = new ComboBox('rol_edit', $this->GetLocalizerCaptions()->GetMessageString('PleaseSelect'));
            $main_editor->addChoice('usuario', 'usuario');
            $main_editor->addChoice('admin', 'admin');
            $main_editor->SetAllowNullValue(false);
            
            $multi_value_select_editor = new MultiValueSelect('rol');
            $multi_value_select_editor->setChoices($main_editor->getChoices());
            
            $text_editor = new TextEdit('rol');
        ...
        protected function AddFieldColumns(Grid $grid, $withDetails = true)
        {
            ...
            $grid->AddViewColumn($column);
            //
            // View column for contraseña field
            //
            $column = new TextViewColumn('contraseña', 'contraseña', 'Contraseña', $this->dataset);
            $column->SetOrderable(true);
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            $grid->AddViewColumn($column);
            //
            ...
            $grid->AddViewColumn($column);
            //
            // View column for rol field
            //
            $column = new TextViewColumn('rol', 'rol', 'Rol', $this->dataset);
            $column->SetOrderable(true);
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            $grid->AddViewColumn($column);
        }
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            //
            // Edit column for contraseña field
            //
            $editor = new TextEdit('contraseña_edit');
            $editor->SetMaxLength(60);
            $editColumn = new CustomEditColumn('Contraseña', 'contraseña', $editor, $this->dataset);
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            ...
            //
            // Edit column for rol field
            //
            $editor = new ComboBox('rol_edit', $this->GetLocalizerCaptions()->GetMessageString('PleaseSelect'));
            $editor->addChoice('usuario', 'usuario');
            $editor->addChoice('admin', 'admin');
            $editColumn = new CustomEditColumn('Rol', 'rol', $editor, $this->dataset);
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
