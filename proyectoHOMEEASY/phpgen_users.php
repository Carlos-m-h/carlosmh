 ...
 */
    ...
    class phpgen_usersPage extends Page
    {
        ...
        {
            $this->SetTitle('Phpgen Users');
            $this->SetMenuLabel('Phpgen Users');
        ...
        protected function setupFilterBuilder(FilterBuilder $filterBuilder, FixedKeysArray $columns)
        {
            ...
            $main_editor = new TextEdit('contraseña');
            ...
            $main_editor = new TextEdit('Usuario');
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            //
            $editor = new TextAreaEdit('contraseña_edit', 50, 8);
            ...
            //
            $editor = new TextAreaEdit('usuario_edit', 50, 8);
