 ...
 */
    ...
    class preciosPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Precios');
            $this->SetMenuLabel('Precios');
    ...
    try
    {
        $Page = new preciosPage("precios", "precios.php", GetCurrentUserPermissionsForPage("precios"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("precios"));
