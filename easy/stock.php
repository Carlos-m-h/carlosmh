 ...
 */
    ...
    class stockPage extends Page
    {
        protected function DoBeforeCreate()
        {
            ...
            $this->dataset->addFields(
                array(
                    ...
                    new StringField('nombre_producto', true),
        ...
        protected function getFiltersColumns()
        {
            return array(
                ...
                new FilterColumn($this->dataset, 'nombre_producto', 'nombre_producto', 'Nombre Producto'),
        ...
        protected function setupQuickFilter(QuickFilter $quickFilter, FixedKeysArray $columns)
        {
            $quickFilter
                ...
                ->addColumn($columns['nombre_producto'])
        ...
        protected function setupFilterBuilder(FilterBuilder $filterBuilder, FixedKeysArray $columns)
        {
            ...
            $main_editor = new TextEdit('nombre_producto_edit');
        ...
        protected function AddFieldColumns(Grid $grid, $withDetails = true)
        {
            ...
            //
            // View column for nombre_producto field
            //
            $column = new TextViewColumn('nombre_producto', 'nombre_producto', 'Nombre Producto', $this->dataset);
            $column->SetOrderable(true);
        ...
        {
            //
            // Edit column for nombre_producto field
            //
            $editor = new TextEdit('nombre_producto_edit');
            $editor->SetMaxLength(100);
            $editColumn = new CustomEditColumn('Nombre Producto', 'nombre_producto', $editor, $this->dataset);
    ...
    try
    {
        $Page = new stockPage("stock", "stock.php", GetCurrentUserPermissionsForPage("stock"), 'UTF-8');
