 ...
 */
    ...
    class permisosPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Permisos');
            $this->SetMenuLabel('Permisos');
    ...
    try
    {
        $Page = new permisosPage("permisos", "permisos.php", GetCurrentUserPermissionsForPage("permisos"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("permisos"));
