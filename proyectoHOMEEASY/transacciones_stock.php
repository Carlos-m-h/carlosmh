 ...
 */
    ...
    class transacciones_stockPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Transacciones Stock');
            $this->SetMenuLabel('Transacciones Stock');
            ...
            $this->dataset->addFields(
                array(
                    ...
                    new IntegerField('id_producto', true),
        ...
        protected function getFiltersColumns()
        {
            return array(
                ...
                new FilterColumn($this->dataset, 'id_producto', 'id_producto', 'Id Producto'),
        ...
        protected function setupFilterBuilder(FilterBuilder $filterBuilder, FixedKeysArray $columns)
        {
            ...
            $main_editor = new TextEdit('id_producto_edit');
            ...
            $main_editor->addChoice('agregar', 'agregar');
            $main_editor->addChoice('quitar', 'quitar');
        ...
        protected function AddFieldColumns(Grid $grid, $withDetails = true)
        {
            ...
            //
            // View column for id_producto field
            //
            $column = new NumberViewColumn('id_producto', 'id_producto', 'Id Producto', $this->dataset);
            $column->SetOrderable(true);
            $column->setNumberAfterDecimal(0);
            $column->setThousandsSeparator(',');
            $column->setDecimalSeparator('');
        ...
        {
            //
            // Edit column for id_producto field
            //
            $editor = new TextEdit('id_producto_edit');
            $editColumn = new CustomEditColumn('Id Producto', 'id_producto', $editor, $this->dataset);
            ...
            $editor->addChoice('agregar', 'agregar');
            $editor->addChoice('quitar', 'quitar');
    ...
    try
    {
        $Page = new transacciones_stockPage("transacciones_stock", "transacciones_stock.php", GetCurrentUserPermissionsForPage("transacciones_stock"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("transacciones_stock"));
